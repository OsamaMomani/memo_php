...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // validators 
    if( $user=='')
        $messege = "Username field is required! ";
    else if( $pass==md5('') )
        ...
        if ($r == 1) 
            $messege = "Username aleardy taken, Please try another username";
        else {
    ...
    <div class="wrapper fadeInDown">
        <div id="formContent">
            ...
            <form action="signin.php" method="POST">
                ...
                <input type="password" id="password" class="fadeIn third" name="password" placeholder="new password">
                <input type="submit" class="fadeIn fourth" value="Sign In">
            </form>

            <!-- Remind Passowrd -->
            <div id="formFooter">
                <a class="underlineHover" href="login.php">already have an account? <b> Login </b> </a> <br>
